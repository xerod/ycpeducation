...
export default function ClientTestimonials() {
  return (
    <div className="relative py-32 bg-white lg:px-10 xl:px-16">
      ...
      <div className="px-4 mt-8 lg:px-32">
        ...
        />
        <p className="text-2xl leading-7 text-left text-gray-800 lg:text-center lg:leading-9 lg:text-3xl font-extralight">
        ...
        <p className="mt-4 text-base font-medium leading-6 text-left text-gray-600 lg:leading-7 lg:text-center lg:text-xl">
