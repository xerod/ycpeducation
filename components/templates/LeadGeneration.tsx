...
export default function LeadGeneration() {
  return (
    <div
      id="contact-us"
      className="relative flex flex-col pb-20 bg-white lg:px-10 xl:px-16 lg:py-20 lg:flex-row"
    >
      <div className="w-full pb-10 overflow-hidden border-gray-200 h-96 lg:min-h-full lg:pb-0 lg:shadow-xl lg:border lg:w-6/12 lg:rounded-xl">
        <iframe
      ...
      <div className="w-full px-4 lg:ml-16 lg:w-6/12">
