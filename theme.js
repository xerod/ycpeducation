export default {
  button: {
    base: "align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition duration-300 font-medium bg-center focus:outline-none",
    primary: {
      base: "text-white bg-gradient-to-bl from-amber-400 via-orange-500 to-orange-600 bg-overflow",
      active:
        "transform focus:ring active:bg-right-bottom hover:bg-left-bottom focus:ring-orange-200 active:ring-0",
